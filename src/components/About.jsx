...
export default function About() {
  return (
    <div>
      ...
      <div className="lg:flex xsm:block lg:justify-evenly">
        <div className="lg:max-w-96 sm:max-w-56  xsm:max-w-56 sm:mx-auto">
          <Lottie animationData={animate} loop={true} />
        </div>
        <div className="lg:text-lg sm:text-lg xsm:text-md  xsm:px-2 antialiased lg:mr-0 xsm:ml-0 tracking-wider lg:leading-surge  xsm:leading-normal lg:mt-4 xsm:mt-8 font-Verdana lg:w-3/6 xsm:w-full opacity-65">
          <Heading
            title={
